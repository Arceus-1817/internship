...
if(Validation.validate_date(BookList, b.getPublishDate()) && Validation.validate_Isbn(BookList, b.getIsbn()) && Validation.validate_Cat(BookList, b.getClass()))
BookList.add(b);
else
...
break;
case 7:
BookList.sort((e1,e2)->e1.getAuthorName().compareTo(e2.getAuthorName()));
break;
